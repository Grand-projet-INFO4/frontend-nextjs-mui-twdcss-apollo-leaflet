...
export default function Dashboard() {
    ...
    return(
        <div className="mx-auto  bg-gray-50 w-full h-auto ">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 justify-center">
                <div className="card w-auto h-auto p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-center text-xl text-black">Chiffre d affaires</h2>
                ...
                <div className="card w-auto h-auto p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-center text-xl text-black">Nombre de résérvations</h2>
                    <div className="flex justify-center mt-2 w-full h-auto">
                ...
                <div className="card w-auto h-auto p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-center text-xl text-black">Nombre de voyages</h2>
                    <div className="flex justify-center mt-2 w-full h-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 p-3 justify-center items-center mt-12 ">
                <div className="relative flex justify-center w-auto h-80 bg-white shadow-md rounded-md">
                    <div className="card w-[90%] h-72 relative  bottom-8 bg-white shadow-md rounded-md">
                        <div className="flex justify-center items-center">
                            <Line data={data} options={options} />
                        </div>
                    </div>
                </div>
                <div className="md:relative flex justify-center w-auto h-80 bg-white shadow-md rounded-md">
                    <div className="card w-[90%] h-72 relative  bottom-8 bg-white shadow-md rounded-md">
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-3 p-3 justify-center mt-3">
                <div className="card w-auto h-32 p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-xl text-black"> Véhicules</h2>
                ...
                <div className="card w-auto h-32 p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-xl text-black">Chauffeurs</h2>
                    <div className="flex justify-between mt-2 w-full h-auto">
                ...
                <div className="card w-auto h-32 p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light text-xl text-black">Stationnement</h2>
                    <div className="flex justify-between mt-2 w-full h-auto">
                  ...
                  <div className="card w-auto h-32 p-4 bg-white shadow-md rounded-md">
                    <h2 className="font-light  text-xl text-black">Itineraires</h2>
                     <div className="flex justify-between mt-2 w-full h-auto">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-2 p-3 justify-center items-center mt-3 ">
                <div className="w-auto h-auto bg-white shadow-md rounded-md">
                    <h2 className="font-light text-center text-xl text-black"> Véhicules répartis par statut</h2>
                ...
                <div className="w-auto h-auto bg-white shadow-md rounded-md">
                     <h2 className="font-light text-center text-xl text-black"> Véhicules répartis selon leurs états</h2>
                 ...
                 <div className="w-auto h-auto bg-white shadow-md rounded-md">
                     <h2 className="font-light text-center text-xl text-black">Chauffeurs répatis par statut</h2>
                     <div className="mt-1 flex justify-center w-full h-40 p-2">
